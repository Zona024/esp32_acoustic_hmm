...
* [x] Implement NVS read logic to auto-load previously saved WLAN credentials on boot
...
* [x] Fill ringbuffer with dummy byte data (e.g., an alternating bit pattern)
...
* [ ] Send dummy data over Network connection  with MQTT
